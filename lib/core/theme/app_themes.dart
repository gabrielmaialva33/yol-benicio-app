...
class AppThemes {
  static ThemeData lightTheme = ThemeData(
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      ...
      elevation: 8,
      selectedLabelStyle:
          AppTextStyles.body1(fontSize: 12, fontWeight: FontWeight.w600),
      unselectedLabelStyle:
          AppTextStyles.body1(fontSize: 12, fontWeight: FontWeight.w400),
    ),
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        textStyle:
            AppTextStyles.body1(fontSize: 16, fontWeight: FontWeight.w600),
      ),
    ),
    ...
    textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(
        ...
        textStyle:
            AppTextStyles.body1(fontSize: 14, fontWeight: FontWeight.w600),
      ),
    ),
    ...
    textTheme: GoogleFonts.interTextTheme().copyWith(
      ...
      displayMedium: AppTextStyles.body1(
          color: AppColors.slate900, fontWeight: FontWeight.w700),
      displaySmall: AppTextStyles.body1(
          color: AppColors.slate900, fontWeight: FontWeight.w600),
      headlineLarge: AppTextStyles.body1(
          color: AppColors.slate900, fontWeight: FontWeight.w700),
      headlineMedium: AppTextStyles.body1(
          color: AppColors.slate900, fontWeight: FontWeight.w600),
      headlineSmall: AppTextStyles.body1(
          color: AppColors.slate900, fontWeight: FontWeight.w600),
      ...
      titleSmall: AppTextStyles.body1(
          color: AppColors.slate900, fontWeight: FontWeight.w500),
      bodyLarge: AppTextStyles.body1(
          color: AppColors.slate900, fontWeight: FontWeight.w400),
      bodyMedium: AppTextStyles.body1(
          color: AppColors.slate500, fontWeight: FontWeight.w400),
      bodySmall: AppTextStyles.body1(
          color: AppColors.slate400, fontWeight: FontWeight.w400),
      labelLarge: AppTextStyles.body1(
          color: AppColors.slate900, fontWeight: FontWeight.w600),
      labelMedium: AppTextStyles.body1(
          color: AppColors.slate500, fontWeight: FontWeight.w500),
      labelSmall: AppTextStyles.body1(
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    textTheme: GoogleFonts.interTextTheme().copyWith(
      ...
      bodyMedium: AppTextStyles.body1(
          color: AppColors.gray400, fontWeight: FontWeight.w400),
      bodySmall: AppTextStyles.body1(
